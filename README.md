...
- 練習試合を組むには、現状電話でのやり取りが慣習的で、メールなどを使用するのは失礼だと考える指導者もいる。そのため毎回電話をしてアポイントを取っていることに、多くの労力が割かれている。
- 高校野球を指導している教員は、部活以外の仕事も多く任されることがあり、非常に多忙である人が多い。
- 苦労して組んだ練習試合でも、コロナウイルスの影響で突然のキャンセルが増え、前日になって次の日の予定が白紙になってしまうことがある。
- 多くの部活動が参加できる練習試合マッチングアプリはすでに存在しているが、他競技も含まれているので、日常で使用している指導者は少ないと感じる。

 上記のことを解決するために、本アプリケーションを開発した。アプリケーションの目的は、次の4つに分けられる。

### 「練習試合をもっと楽に組める」＋「いままでの慣習を根本的には崩さない」
これを実現するために「練習試合募集の掲示板」の意味合いが強いアプリにする。
...
### 競技を限定することで、情報量が少なくなり、扱いやすいアプリケーションにする。
「高校野球」と競技を限定的にすることで、より競技性とマッチした内容にする。アプリケーションの操作が苦手な教員でも扱いやすいことを重点に置く。

以上の目的を達成するために、本アプリケーションの開発を行なった。
